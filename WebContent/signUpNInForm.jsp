...
<div class="wrapper">
  <div class="container">
    <div class="sign-up-container">
      <form name="signUpForm" action="signUp.jsp" method="post" id="signUpForm">
        <h1>회원가입</h1>
        ...
        <input type="submit" class="form_btn" name="SignUpBtn" value="회원가입">
      </form>
    </div>
    <div class="sign-in-container">
      <form action="signIn.jsp" method="post" id="signInForm">
        ...
        <span></span>
        <input type="text" placeholder="아이디" name="userId" id="userIdIn">
        <input type="password" placeholder="비밀번호" name="password" id="passwordIn">
        <input type="submit" class="form_btn" name="SignInBtn" value="로그인">
      </form>
    </div>
    <div class="overlay-container">
      <div class="overlay-left">
        <h1>돌아오신 것을<br> 환영합니다!</h1>
        <p>수 많은 회원들이<br>당신만의 레시피 공유를 기다립니다!</p>
