  ...
  <div class="container" id="center" style="height:1200px">
    <div class="row"> <!-- 왼쪽(게시판)과 오른쪽(내용) 정렬 -->
	  ...
	  <div class="col-lg-9" id ="center_right"> <!-- 오른쪽(내용) -->
			...
			<hr>
			<strong>종류 : </strong>
			<%=rec_category%><br> <strong>글쓴이 : </strong>
			<%=writer_id%><br> <strong>조회수 : </strong>
			<%=rec_views%><br> <strong>등록일 :</strong>
			<%=rec_date%>
			<br> <strong>내용 : </strong>
			<%=rec_content%><br>
			...
			<div class=imgView>
				<%
					if (rec_pic1 != "") {
				%>
				<img src="/projectCook1/rec_pic/<%=rec_pic1%>"
					alt="게시글 <%=rec_num%>의 picture1">
				<%
					}
					if (rec_pic2 != "") {
				%>
				<img src="/projectCook1/rec_pic/<%=rec_pic2%>"
					alt="게시글 <%=rec_num%>의 picture2">
				<%
					}
					if (rec_pic3 != "") {
				%>
				<img src="/projectCook1/rec_pic/<%=rec_pic3%>"
